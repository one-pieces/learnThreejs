...
function main() {
    ...
    const wheelMeshs = wheelPositions.map((position) => {
    ...
    function render(time) {
        ...
        if ( resizeRendererToDisplaySize( renderer ) ) {
            ...
            cameras.forEach((cameraInfo) => {
                cameraInfo.cam.aspect = canvas.clientWidth / canvas.clientHeight;
        ...
        // make the turretCamera look at the target
        turretCamera.lookAt(targetPosition);

        // make the targetCamera look at the tank
        tank.getWorldPosition(targetPosition);
        targetCamera.lookAt(targetPosition);

        wheelMeshs.forEach((wheelMesh) => {
